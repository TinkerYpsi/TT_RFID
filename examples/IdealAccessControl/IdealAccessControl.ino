...
void setup() {
  ...
  initializeRFID();    // Initialize RFID Module

  //If you set Antenna Gain to Max it will increase reading distance
  //mfrc522.PCD_SetAntennaGain(mfrc522.RxGain_max);

  Serial.println(F("Access Control Example v0.1"));
  ShowReaderDetails();  // Show details of Card Reader
  toggleDeleteAllRecords(wipeB);
  bool masterDefined = isMasterDefined();
  if(!masterDefined) {
    defineMasterCard();
  }
  printInitMessage();
